...
/**
 * swap - utility functions to swap to Integers
 * @a: integer a
 * @b: integer b
 **/
...
/**
 * maxHeapify - The main function to heapify a Maximum Heap. The function
...
/**
 * heap_sort -  The main functions to sort an array of given size
 * @array: array to sort
...
void heap_sort(int *array, size_t size)
{
	int i;
	/**
	 * Start from bottom and rightmost internal mode and heapify all
    ...
    * The last element in maximum heap will be the minimum element
	*/
	for (i = (size - 1); i > 0; --i)
	{
		/**
