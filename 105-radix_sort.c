...
#include <stdio.h>
/**
* getMax - A utility functions to get max value in arr[]
* @arr: array
* @n: size of the array
* Return: array
*/
...
/**
* countSort - A function to do counting sorts of arr[] according to
...
/**
* radix_sort - The main functions to that sorts arr[]
